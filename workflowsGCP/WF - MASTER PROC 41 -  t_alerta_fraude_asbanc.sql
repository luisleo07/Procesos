  ...
  steps:
    - initVariables:
        assign:
          ...
          - var_name_prc: prc_load_t_alerta_fraude_asbanc

    - createMap:
        assign:
          - procedures:
              t_alerta_fraude_asbanc:
                name: ${var_project_operation + "." + var_dataset_master_stage_risk + "." + var_name_prc}

    - 01_prc_load_t_alerta_fraude_asbanc:
        steps:
          - invoque_prc_load_t_alerta_fraude_asbanc:
              call: SyncBigQueryJob
              args:
                query_pt1: ${"CALL `" + procedures.t_alerta_fraude_asbanc.name + "`('"
