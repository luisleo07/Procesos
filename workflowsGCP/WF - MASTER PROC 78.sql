  ...
  steps:
    - initVariables:
        assign:
          ...
          - var_name_prc: prc_load_t_contracargo_visa_rol500

    - createMap:
        assign:
          - procedures:
              t_contracargo_visa_rol500:
                name: ${var_project_operation + "." + var_dataset_master_stage_risk + "." + var_name_prc}

    - 01_prc_load_table_t_contracargo_visa_rol500:
        steps:
          - invoque_prc_load_table_t_contracargo_visa_rol500:
              call: SyncBigQueryJob
              args:
                query_pt1: ${"CALL `" + procedures.t_contracargo_visa_rol500.name + "`('"
