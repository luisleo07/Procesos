...
main:
    ...
    # model_input:
    #{
    #   "bq_project_id": "prd-izipay-data-operation",
    ...
    #   "process_date": "CURRENT_DATE('America/Lima')",
    ...
    - initVariables:
        assign:
            ...
            - var_name_prc_biglake: prc_load_table_bqomni_dataentry_operaciones_transaccional_hist
            ...
            - var_name_prc_01: prc_load_dataentry_operaciones_rol500_incoming
            - var_name_prc_02: prc_load_dataentry_operaciones_rol500_outgoing
