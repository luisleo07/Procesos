...
tarjeta_enmascarada STRING  OPTIONS(description='Numero de tarjeta (enmascarada) con el que se realizo la transaccion'),
bin STRING  OPTIONS(description='Primeros 9 digitos de la tarjeta con la que se realizo la transaccion'),
