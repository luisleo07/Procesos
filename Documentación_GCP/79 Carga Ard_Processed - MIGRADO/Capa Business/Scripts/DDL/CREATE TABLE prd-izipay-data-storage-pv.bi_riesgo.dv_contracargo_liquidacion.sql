...
tarjeta_enmascarada STRING  OPTIONS(description='Numero de la tarjeta (enmascarada) con la que se realizo la transaccion'),
bin STRING  OPTIONS(description='Primeros 9 digitos de la tarjeta (enmascarada) con la que se realizo la transaccion'),
