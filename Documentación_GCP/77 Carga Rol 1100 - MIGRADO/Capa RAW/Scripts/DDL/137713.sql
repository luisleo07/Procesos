CREATE OR REPLACE TABLE prd-izipay-data-storage-pv.raw_dataentry_operaciones.137713 (
...
OPTIONS (description='Cola de trabajo principal que contiene las disputas o contracargos entrantes que están "en espera de acción". Estos casos deben ser analizados y procesados.');
