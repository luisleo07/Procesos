CREATE OR REPLACE TABLE prd-izipay-data-storage-pv.raw_dataentry_operaciones.137714 (
...
OPTIONS (description='Registro de todos los contracargos (disputas iniciales) que ya han sido gestionados y enviados a la red. Sirve para consulta de estatus y auditoría.');
