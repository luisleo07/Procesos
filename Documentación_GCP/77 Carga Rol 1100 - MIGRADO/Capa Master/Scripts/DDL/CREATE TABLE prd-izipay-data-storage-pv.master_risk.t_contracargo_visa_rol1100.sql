...
tarjeta_enmascarada STRING  OPTIONS(description='Numero de la tarjeta del cliente (enmascarada)'),
bin_token STRING  OPTIONS(description='Primeros 9 digitos de la tarjeta tokenizada'),
tarjeta_enmascarada_token STRING  OPTIONS(description='Numero de la tarjeta tokenizada del cliente (enmascarada)'),
...
PRIMARY KEY (bin, tarjeta_enmascarada, tarjeta_enmascarada_token) NOT ENFORCED
)
