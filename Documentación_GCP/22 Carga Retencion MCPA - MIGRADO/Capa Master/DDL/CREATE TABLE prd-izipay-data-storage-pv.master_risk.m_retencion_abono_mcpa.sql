CREATE OR REPLACE TABLE prd-izipay-data-storage-pv.master_risk.m_retencion_abono_mcpa (
...
party_id_izi STRING  OPTIONS(description='Código correspondiente al documento afiliado del cliente en IziPay'),
...
OPTIONS (description='Tabla que contiene el reporte de retenciones de abonos a comercios por sospecha de fraude. Equivalente al reporte MCPA011 del AS400');
